...
class UserModelTest(TestCase):
    ...
    def test_user_creation(self):
        user = User.objects.create_user(username="testuser", password="password123", user_type="teacher")
        user.full_clean()
...
class StudentModelTest(TestCase):
    ...
    def setUp(self):
        self.student_user = User.objects.create_user(username="studentuser", password="password123", user_type="student")
    ...
    def test_student_creation_invalid_user_type(self):
        teacher_user = User.objects.create_user(username="teacheruser", password="password123", user_type="teacher")
        
        with self.assertRaises(ValidationError):
            student = Student(user=teacher_user, academic_year=2, phone="01012345678", parent_phone="01098765432")
            student.full_clean()
