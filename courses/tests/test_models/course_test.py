...
class CourseModelTest(TestCase):
    ...
    def test_clean_method_teacher_verification(self):
        ...
        unverified_teacher = Teacher.objects.create(user=unverified_teacher_user, is_verified=False)
    ...
    def test_can_enroll(self):
        student = Student.objects.create(user=self.student_user, academic_year=2, phone="01012345678", parent_phone="01098765432", parent_name="Parent Name")
        self.course.publish()
